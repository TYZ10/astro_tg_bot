...
class HoroscopeForBusiness(BasicBotOperation):
    ...
    async def horoscope_for_business(
        ...
        await call.message.answer("""💼 Хочешь выстроить свой путь к успеху? Бизнес-гороскоп покажет, как двигаться к своим целям с лёгкостью и гармонией. Мы поможем тебе:
✨ Найти своё предназначение в карьере и финансовой сфере.
🚀 Определить подходящее время для новых начинаний и решений.
🌟 Узнать, как привлекать деньги с минимальными усилиями и максимальной отдачей.

Звёзды укажут путь к финансовой свободе. 💰""")

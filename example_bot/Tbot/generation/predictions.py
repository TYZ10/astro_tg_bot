...
""",
             ...
             text = """📅 Гороскоп на месяц — это краткий и точный прогноз для ближайших 30 дней. Ты узнаешь, где тебя ждёт успех, а где стоит быть внимательнее. Звёзды подскажут лучшие моменты для действий. 🌙"
...
Каждый месяц уникален, и этот прогноз поможет тебе использовать его возможности на максимум. Жми кнопку и узнавай, что тебя ждёт! 🌠"""
            ...
            text = """🗓️ Гороскоп на 2025 год — это твой личный путеводитель на целый год. Ты узнаешь, какие возможности и вызовы ждут тебя, в какие моменты стоит действовать, а когда лучше сделать паузу. Всё это — на основе твоих астрологических данных! 🌟"
